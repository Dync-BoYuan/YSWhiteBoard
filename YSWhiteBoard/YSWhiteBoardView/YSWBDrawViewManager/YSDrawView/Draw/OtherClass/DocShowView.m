...
//    NSString *s2 = [s1 stringByReplacingOccurrencesOfString:@" " withString:@""];
    [[YSRoomInterface instance] pubMsg:sYSSignalSharpsChange msgID:shapeID toID:YSRoomPubMsgTellAll data:s1 save:YES extensionData:@{} associatedMsgID:nil associatedUserID:nil expires:0 completion:^(NSError *error) {
        NSLog(@"%@",error);
    }];
